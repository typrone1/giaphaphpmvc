...
function printCell(lunarDate, solarDate, solarMonth, solarYear) {
    ...
    res += (' <div style=color:' + solarColor + ' class="' + solarClass + '">' + solarDate + '' + '</div> <div class="' + lunarClass + ' day-contents">' + lunar + (ngayGio ? ngayGio : '') + '' + '</div></td>\n');
    return res;
}
function clickNgayGio(maSuKien) {
    // alert(maSuKien);
    displayModal(maSuKien);
}
